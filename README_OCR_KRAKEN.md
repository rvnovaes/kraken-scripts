...
Este repositório contém um script Bash para executar OCR em arquivos PDF usando o **Kraken OCR**, com conversão prévia das páginas para imagens por meio do `pdftocairo` e processamento paralelo controlado pelo usuário.
